...
void main() {
  Atleta ok = Atleta("Pedro", 18, 76, "121.692.176-33", "pedro", 500, "Futsal");
  ok.comer(9000);
  ok.treinar(7000);
  ok.gastarSalario(500);

  Atleta ok2 = Atleta("Peter", 18, 90, "121.690.176-33", "pete", 600, "Fut");
  ok2.comer(8000);
  ok2.treinar(1000);
  ok2.gastarSalario(500);

  Tecnico ok3 = Tecnico("Ricardo", 46, 80, "111.111.111-11", "teste", 1000);
  ok3.planejarTreino("Teste", DateTime.parse("2001-12-06"));

  Diretor ok4 = Diretor("Paulo", 57, 80, "121.111.111-11", "teste1", 10000);
